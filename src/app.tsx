...
export function App() {
  const [ isGuestsInputOpen, setIsGuestsInputeOpen ] = useState(false)
  ...
  function openGuestsInput() {
    setIsGuestsInputeOpen(true)
  }

  function closeGuestsInput() {
    setIsGuestsInputeOpen(false)
  }
            ...
            <form onSubmit={addNewEmailToInvite} className="p-2.5 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2">
              <div className="px-2 flex items-center flex-1 gap-2">
                ...
                <input 
                  type="email" 
                  name="email" 
                  placeholder="Digite o e-mail do conidado"  
